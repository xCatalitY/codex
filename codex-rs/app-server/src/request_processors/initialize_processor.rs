...
use codex_login::default_client::get_codex_user_agent_for_identity;
...
impl InitializeRequestProcessor {
    ...
    pub(crate) async fn initialize(
        ...
        let client_identity =
            client_identity_from_parts(originator.clone(), Some(user_agent_suffix)).map_err(
                |_| {
        ...
        let user_agent = get_codex_user_agent_for_identity(&client_identity);
